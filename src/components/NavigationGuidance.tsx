...
// interface NavigationGuidanceProps {
//   guidance: string;        // Textual guidance from the backend
//   visualContext: string;   // What the AI sees (optional/extra)
//   lastCommand: string;     // The voice command given
//   isLoading: boolean;      // Loading indicator during fetch
// }
